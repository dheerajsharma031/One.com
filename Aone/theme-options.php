...
if ( ! class_exists( 'Aone_Options' ) ) {
    ...
    class Aone_Options {
        ...
        public function __construct() {
            ...
            if ( is_admin() ) {
                add_action( 'admin_menu', array( 'Aone_Options', 'add_admin_menu' ) );
                add_action( 'admin_init', array( 'Aone_Options', 'register_settings' ) );
            }
        ...
        public static function add_admin_menu() {
            add_menu_page(
                ...
                'manage_options',
                'theme-settings',
                array( 'Aone_Options', 'create_admin_page' )
            );
        }
        ...
        public static function register_settings() {
            register_setting( 'theme_options', 'theme_options', array( 'Aone_Options', 'sanitize' ) );
        }
                ...
                <form method="post" action="options.php">
                    ...
                    <table class="form-table ONE-custom-admin-login-table">
                        ...
                        <tr valign="top" class="ONE-custom-admin-screen-background-section">
                            <th scope="row"><?php esc_html_e( 'Select font Name', 'one' ); ?></th>
                            <td>
                        ...
                        <tr><th><h4>Home Page Portion  one</h4></th></tr>

                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 1 title', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 1 Button Label', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 1 Button Link', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 1 Content', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 1 Background image', 'one' ); ?></th>
                            <td>
                        ...
                        <tr><th><h4>Home Page Portion  two</h4></th></tr>

                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 2 title', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 2 Button Label', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 2 Button Link', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 2 Content', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 2 Background image', 'one' ); ?></th>
                            <td>
                        ...
                        <tr><th><h4>Home Page Portion  three</h4></th></tr>

                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 3 title', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 3 Button Label', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 3 Button Link', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 3 Content', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 3 Background image', 'one' ); ?></th>
                            <td>
                        ...
                        <tr><th><h4>Home Page Portion  four</h4></th></tr>

                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 4 title', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 4 Button Label', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 4 Button Link', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 4 Content', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 4 Background image', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top"><th><h4>Home Page Portion  five</h4></th></tr>

                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 5 title', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 5 Button Label', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 5 Button Link', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 5 Content', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 5 Background image', 'one' ); ?></th>
                            <td>
                        ...
                        <tr><th><h4>Home Page Portion  six</h4></th></tr>


                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 6 title', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 6 Button Label', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 6 Button Link', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 6 Content', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Portion 6 Background image', 'one' ); ?></th>
                            <td>
                    ...
                    <tr><th><h4>Footer Sections</h4></th></tr>
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Footer Portion 1 title', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Footer Portion 1 Content', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Footer Portion 2 title', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Footer Portion 2 Content', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Footer Portion 3 title', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Footer Portion 3 Content', 'one' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Footer Portion 4 title', 'one' ); ?></th>
                            <td>
...
// Helper function to use in your theme to return a theme option value
    ...
    return Aone_Options::get_theme_option( $id );
}

add_action( 'wp_head', 'my_wp_head' );
function my_wp_head() {
    $options = (array) one_get_theme_option('font');
    $fonts = Aone_Options::get_fonts();
